                            ...
                            <div class="col-lg-11">
                                <div class="hero__caption">
                                    <div class="hero-text1">
                                        <span data-animation="fadeInUp" data-delay=".3s">Gestion de accidentes laborales y capacitaciones</span>
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="services_details.html">Gestion de accidentes laborales</a></h4>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="services_details.html">Generacion de capacitaciones </a></h4>
                            </div>
                            <div class="service-icon">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/icon/services_icon1.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="services_details.htmlaa">Implementacion de mejoras dentro de su empresa</a></h4>
                            </div>
                            <div class="service-icon">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/icon/services_icon1.png" alt="">
                            </div>
            ...
            <div class="support-wrapper align-items-end">
                <div class="left-content">
                    ...
                    <div class="support-caption">
                        ...
                        <a href="about.html" class="btn red-btn2">Leer mas</a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/team/team1.jpg" alt="">
                            </div>
                            <div class="team-caption">
                                <span>El Weon que porgrama </span>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/team/team3.png" alt="">
                            </div>
                            <div class="team-caption">
                                <span>Algo</span>
                                <h3>Pilar</h3>
